...
// Resolve a token to a voter name
...
// Get existing vote for this voter this month
...
// Cast or update a vote — upsert handles both insert and update
...
// Get all votes for a month (admin only)
...
// Clear all votes for a month (admin reset)
